...
ACCEPTABLE_LOSS_PERCENTAGE  = 0.5        # (Em base 100%) O quando o bot aceita perder de % (se for negativo, o bot só aceita lucro)
...
TP_AMOUNT_PERCENTAGE =  []   # Vende [A%, B%]
...
stocks_traded_list = [XRP_USDT,ADA_USDT]
